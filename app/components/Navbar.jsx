...
const Navbar = ({isDarkMode, setIsDarkMode}) => {
  ...
  return (
    ...
    <div className='fixed top-0 right-0 w-11/12 -z-10 translate-y-[-80%] dark:hidden'>
      ...
      <h2 className=' text-2xl w-28 font-semibold cursor-pointer mr-14 sm:text-3xl font-Ovo'><a href="#top">Ehigiamusoe</a></h2>
        ...
        <div className='flex items-center gap-4'>
         <button onClick={()=>setIsDarkMode(prev => !prev)}>
          ...
          lg:flex items-center gap-3 px-10 py-2.5 border
           border-gray-500 rounded-full
            ml-4 font-Ovo dark:border-white/50'>Contact 
          ...
          <ul ref={sideMenuRef} className='flex md:hidden flex-col gap-4 py-20 px-10 fixed -right-56
           top-0 bottom-0 w-56 z-50 h-screen bg-rose-50 transition 
