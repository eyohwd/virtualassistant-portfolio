    ...
    <motion.div
     ...
     id='work' className='w-full px-[12%] py-10 scroll-mt-20'>
      ...
      className='grid grid-cols-auto my-10 gap-5 dark:text-black'>
        ...
        key={index}
             className='border border-gray-400 aspect-square bg-no-repeat bg-cover bg-center rounded-lg relative
             cursor-pointer group'
             style={{backgroundImage: `url(${project.bgImage})`}}>
            <div className='bg-white w-10/12 absolute bottom-5 left-1/2
            -translate-x-1/2 py-2 px-5 flex items-center justify-between duration-500
